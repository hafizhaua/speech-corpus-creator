...
export default function Home() {
  ...
  const convert = async () => {
    ...
    await ffmpeg.writeFile("input.webm", await fetchFile(recorded as Blob));
    ...
    // Assuming you have an audio element reference to preview the transcoded WAV file
    if (audioRef.current)
  ...
  return (
    <div className="px-12 py-32">
      <div className="flex gap-12">
        ...
        {/* {loaded && <audio controls ref={audioRef} />} */}
      </div>
      {loaded ? (
